...
use Rixl\Sdk\Models\Analytics\V1\TopImagesResponse;
...
class ImagesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/analytics/v1/top/images{?limit*,range%2Eend*,range%2Estart*}');
     ...
     * @return Promise<TopImagesResponse|null>
     * @throws Exception
    */
    public function get(?ImagesRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        $requestInfo = $this->toGetRequestInformation($requestConfiguration);
        return $this->requestAdapter->sendAsync($requestInfo, [TopImagesResponse::class, 'createFromDiscriminatorValue'], null);
    }
