...
use Rixl\Sdk\Analytics\V1\Videos\Item\Heatmap\HeatmapRequestBuilder;
use Rixl\Sdk\Analytics\V1\Videos\Item\HotSegments\HotSegmentsRequestBuilder;
use Rixl\Sdk\Analytics\V1\Videos\Item\Stats\StatsRequestBuilder;
...
class WithVideo_ItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function hotSegments(): HotSegmentsRequestBuilder {
        return new HotSegmentsRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/analytics/v1/videos/{video_id}');
