...
class HotSegmentsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
     ...
     * @throws Exception
    */
    public function get(?HotSegmentsRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        $requestInfo = $this->toGetRequestInformation($requestConfiguration);
        return $this->requestAdapter->sendAsync($requestInfo, [HotSegmentsResponse::class, 'createFromDiscriminatorValue'], null);
    }
    ...
    */
    public function toGetRequestInformation(?HotSegmentsRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
     ...
     * @return HotSegmentsRequestBuilder
    */
    public function withUrl(string $rawUrl): HotSegmentsRequestBuilder {
        return new HotSegmentsRequestBuilder($rawUrl, $this->requestAdapter);
    }
