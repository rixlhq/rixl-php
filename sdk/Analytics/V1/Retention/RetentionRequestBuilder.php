...
*/
class RetentionRequestBuilder extends BaseRequestBuilder 
{
    /**
    ...
    */
     ...
     * @return RetentionRequestBuilder
    */
    public function withUrl(string $rawUrl): RetentionRequestBuilder {
        return new RetentionRequestBuilder($rawUrl, $this->requestAdapter);
    }
