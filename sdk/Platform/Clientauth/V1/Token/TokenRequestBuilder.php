...
use Rixl\Sdk\Models\Clientauth\V1\MintClientTokenResponse;
...
class TokenRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/platform/clientauth/v1/token');
    ...
    /**
     * MintClientToken
     * @param MintClientTokenRequest $body The request body
