...
class CredentialsRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?string $orgId = null, ?int $paginationLimit = null, ?int $paginationOffset = null): CredentialsRequestBuilderGetQueryParameters {
        return new CredentialsRequestBuilderGetQueryParameters($orgId, $paginationLimit, $paginationOffset);
    }
