...
use Rixl\Sdk\Models\Platformauth\V1\ExchangeAPIKeyRequest;
...
class TokenRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/platform/auth/v1/token');
    ...
    /**
     * ExchangeAPIKey
     * @param ExchangeAPIKeyRequest $body The request body
     ...
     * @throws Exception
    */
    public function post(ExchangeAPIKeyRequest $body, ?TokenRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(ExchangeAPIKeyRequest $body, ?TokenRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
