...
use Rixl\Sdk\Models\Types\MoveProjectRequest;
...
class MoveRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/organization/{orgId}/projects/{projectId}/move');
     ...
     * @param MoveProjectRequest $body Target organization ID
     ...
     * @throws Exception
    */
    public function post(MoveProjectRequest $body, ?MoveRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(MoveProjectRequest $body, ?MoveRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
