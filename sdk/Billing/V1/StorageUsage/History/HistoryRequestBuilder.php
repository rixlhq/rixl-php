...
use Rixl\Sdk\Models\Billingv1\GetStorageUsageHistoryResponse;
...
class HistoryRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/billing/v1/storage-usage/history{?days*}');
     ...
     * @return Promise<GetStorageUsageHistoryResponse|null>
     * @throws Exception
    */
    public function get(?HistoryRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        $requestInfo = $this->toGetRequestInformation($requestConfiguration);
        return $this->requestAdapter->sendAsync($requestInfo, [GetStorageUsageHistoryResponse::class, 'createFromDiscriminatorValue'], null);
    }
