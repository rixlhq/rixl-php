...
use Rixl\Sdk\Models\Github_com_rixlhq_api_internal_videos_handler_upload\InitResponse;
use Rixl\Sdk\Models\VideoUploadInitRequest;
...
class InitRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/videos/upload/init');
     ...
     * @throws Exception
    */
    public function post(VideoUploadInitRequest $body, ?InitRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(VideoUploadInitRequest $body, ?InitRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
