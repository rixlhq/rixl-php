...
class WithSubtitleItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/videos/{videoId}/subtitles/{subtitleId}');
    ...
    */
    public function delete(?WithSubtitleItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [SubtitleDelete::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
