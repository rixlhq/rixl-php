...
*/
class SubtitlesPostRequestBody implements ComposedTypeWrapper, Parsable 
{
    /**
    ...
    */
     ...
     * @return SubtitlesPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): SubtitlesPostRequestBody {
        $result = new SubtitlesPostRequestBody();
