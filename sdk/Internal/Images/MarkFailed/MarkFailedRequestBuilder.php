...
use Rixl\Sdk\Models\Images\V1\MarkImageFailedRequest;
...
class MarkFailedRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/internal/images/mark-failed');
    ...
    /**
     * MarkImageFailed
     * @param MarkImageFailedRequest $body The request body
     ...
     * @throws Exception
    */
    public function post(MarkImageFailedRequest $body, ?MarkFailedRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(MarkImageFailedRequest $body, ?MarkFailedRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
