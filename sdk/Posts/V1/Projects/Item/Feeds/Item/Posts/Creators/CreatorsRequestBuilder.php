...
use Rixl\Sdk\Posts\V1\Projects\Item\Feeds\Item\Posts\Creators\Item\WithCreatorItemRequestBuilder;
...
class CreatorsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/posts/v1/projects/{projectId}/feeds/{feedId}/posts/creators');
