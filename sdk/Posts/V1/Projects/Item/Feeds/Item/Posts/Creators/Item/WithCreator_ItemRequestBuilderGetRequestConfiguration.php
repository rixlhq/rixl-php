...
class WithCreator_ItemRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?int $paginationLimit = null, ?int $paginationOffset = null): WithCreator_ItemRequestBuilderGetQueryParameters {
        return new WithCreator_ItemRequestBuilderGetQueryParameters($paginationLimit, $paginationOffset);
    }
