...
use Rixl\Sdk\Images\Upload\Complete\CompleteRequestBuilder;
use Rixl\Sdk\Images\Upload\Init\InitRequestBuilder;
...
class UploadRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/images/upload');
