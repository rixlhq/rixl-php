...
use Rixl\Sdk\Auth\V1\Passkey\Login\Begin\BeginRequestBuilder;
use Rixl\Sdk\Auth\V1\Passkey\Login\Finish\FinishRequestBuilder;
...
class LoginRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/auth/v1/passkey/login');
