...
use Rixl\Sdk\Models\Auth\V1\EmailStatusResponse;
...
class StatusRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/auth/v1/users/current/emails/status{?user_id*}');
     ...
     * @return Promise<EmailStatusResponse|null>
     * @throws Exception
    */
    public function get(?StatusRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        $requestInfo = $this->toGetRequestInformation($requestConfiguration);
        return $this->requestAdapter->sendAsync($requestInfo, [EmailStatusResponse::class, 'createFromDiscriminatorValue'], null);
    }
