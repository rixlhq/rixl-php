...
use Rixl\Sdk\Models\Auth\V1\SendBlogBroadcastRequest;
use Rixl\Sdk\Models\Auth\V1\SendBlogBroadcastResponse;
...
class BroadcastRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * SendBlogBroadcast
     * @param SendBlogBroadcastRequest $body The request body
     ...
     * @throws Exception
    */
    public function post(SendBlogBroadcastRequest $body, ?BroadcastRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(SendBlogBroadcastRequest $body, ?BroadcastRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
