...
use Rixl\Sdk\Media\V1\Projects\Item\Videos\Item\Subtitles\Language\Item\WithLanguage_codeItemRequestBuilder;
...
class LanguageRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/media/v1/projects/{project_id}/videos/{video_id}/subtitles/language');
