...
use Rixl\Sdk\Media\Images\Upload\Complete\CompleteRequestBuilder;
use Rixl\Sdk\Media\Images\Upload\Init\InitRequestBuilder;
...
class UploadRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/media/images/upload');
