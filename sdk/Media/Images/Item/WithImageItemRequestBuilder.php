...
class WithImageItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/media/images/{imageId}');
     ...
     * @return Promise<WithImageDeleteResponse|null>
     * @throws Exception
    */
    public function delete(?WithImageItemRequestBuilderDeleteRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [WithImageDeleteResponse::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
