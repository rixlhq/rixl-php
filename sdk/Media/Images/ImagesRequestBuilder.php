...
use Rixl\Sdk\Media\Images\Item\WithImageItemRequestBuilder;
use Rixl\Sdk\Media\Images\Upload\UploadRequestBuilder;
...
class ImagesRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Gets an item from the Rixl/Sdk.media.images.item collection
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/media/images{?limit*,offset*,order*,sort*}');
