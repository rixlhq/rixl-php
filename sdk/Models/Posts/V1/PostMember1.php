...
class PostMember1 implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PostMember1 and sets the default values.
    */
     ...
     * @return PostMember1
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PostMember1 {
