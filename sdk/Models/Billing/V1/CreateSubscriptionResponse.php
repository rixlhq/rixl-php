...
class CreateSubscriptionResponse implements Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $stripeCustomerId The stripeCustomerId property
    */
    private ?string $stripeCustomerId = null;
    
    /**
     * @var string|null $stripeSubscriptionId The stripeSubscriptionId property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'currentPeriodEnd' => fn(ParseNode $n) => $o->setCurrentPeriodEnd($n->getDateTimeValue()),
            ...
            'stripeCustomerId' => fn(ParseNode $n) => $o->setStripeCustomerId($n->getStringValue()),
            'stripeSubscriptionId' => fn(ParseNode $n) => $o->setStripeSubscriptionId($n->getStringValue()),
        ];
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeDateTimeValue('currentPeriodEnd', $this->getCurrentPeriodEnd());
    ...
    */
     ...
     * @param DateTime|null $value Value to set for the currentPeriodEnd property.
    */
    ...
    */
     ...
     * @param string|null $value Value to set for the stripeCustomerId property.
    */
     ...
     * @param string|null $value Value to set for the stripeSubscriptionId property.
    */
