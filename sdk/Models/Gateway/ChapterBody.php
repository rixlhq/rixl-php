...
class ChapterBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ChapterBody and sets the default values.
    */
     ...
     * @return ChapterBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ChapterBody {
