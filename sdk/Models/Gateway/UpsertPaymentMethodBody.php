...
*/
class UpsertPaymentMethodBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UpsertPaymentMethodBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UpsertPaymentMethodBody {
