...
*/
class PasskeyRegisterFinishBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<int>|null $credential The credential property
    */
    ...
    */
    ...
    /**
     * Instantiates a new PasskeyRegisterFinishBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PasskeyRegisterFinishBody {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'credential' => function (ParseNode $n) {
    ...
    */
     ...
     * @param array<int>|null $value Value to set for the credential property.
    */
    public function setCredential(?array $value): void {
