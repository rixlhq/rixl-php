 ...
 * New name
*/
class UpdateOrgNameBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UpdateOrgNameBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UpdateOrgNameBody {
