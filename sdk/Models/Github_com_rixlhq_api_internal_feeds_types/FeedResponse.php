...
class FeedResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new FeedResponse and sets the default values.
    */
     ...
     * @return FeedResponse
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): FeedResponse {
