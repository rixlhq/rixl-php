...
use Rixl\Sdk\Models\Chapter;
use Rixl\Sdk\Models\File;
use Rixl\Sdk\Models\Github_com_rixlhq_api_db_sqlc\PlanType;
use Rixl\Sdk\Models\Image;

class VideoResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new VideoResponse and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VideoResponse {
