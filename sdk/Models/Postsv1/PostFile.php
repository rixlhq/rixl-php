...
class PostFile implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PostFile and sets the default values.
    */
     ...
     * @return PostFile
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PostFile {
        return new PostFile();
    }
