...
class PostImage implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PostImage and sets the default values.
    */
     ...
     * @return PostImage
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PostImage {
