...
class DeleteResult implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DeleteResult and sets the default values.
    */
     ...
     * @return DeleteResult
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DeleteResult {
