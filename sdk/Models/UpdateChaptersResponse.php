...
class UpdateChaptersResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UpdateChaptersResponse {
