...
class PaginatedResponseVideo implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<Video>|null $data Data contains the slice of items for the current request.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PaginatedResponseVideo and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PaginatedResponseVideo {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'data' => fn(ParseNode $n) => $o->setData($n->getCollectionOfObjectValues([Video::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<Video>|null $value Value to set for the data property.
    */
