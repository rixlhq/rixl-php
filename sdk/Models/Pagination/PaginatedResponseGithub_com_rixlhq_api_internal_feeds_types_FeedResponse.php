...
class PaginatedResponseGithub_com_rixlhq_api_internal_feeds_types_FeedResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<FeedResponse>|null $data Data contains the slice of items for the current request.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PaginatedResponseGithub_com_rixlhq_api_internal_feeds_types_FeedResponse and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PaginatedResponseGithub_com_rixlhq_api_internal_feeds_types_FeedResponse {
        return new PaginatedResponseGithub_com_rixlhq_api_internal_feeds_types_FeedResponse();
    }
    ...
    */
     ...
     * @return array<FeedResponse>|null
    */
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'data' => fn(ParseNode $n) => $o->setData($n->getCollectionOfObjectValues([FeedResponse::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<FeedResponse>|null $value Value to set for the data property.
    */
