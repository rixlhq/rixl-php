...
class PaginatedResponseImage implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<Image>|null $data Data contains the slice of items for the current request.
    */
    ...
    */
    ...
    /**
     * Instantiates a new PaginatedResponseImage and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PaginatedResponseImage {
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'data' => fn(ParseNode $n) => $o->setData($n->getCollectionOfObjectValues([Image::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<Image>|null $value Value to set for the data property.
    */
