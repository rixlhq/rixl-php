...
class AudioTrackDelete implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): AudioTrackDelete {
