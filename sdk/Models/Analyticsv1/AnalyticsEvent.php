...
class AnalyticsEvent implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var float|null $timestamp The timestamp property
    */
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'timestamp' => fn(ParseNode $n) => $o->setTimestamp($n->getFloatValue()),
        ];
    }
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        $writer->writeFloatValue('timestamp', $this->getTimestamp());
    ...
    */
     ...
     * @param float|null $value Value to set for the timestamp property.
    */
    public function setTimestamp(?float $value): void {
